  ...
  return (
    <div className="shadow-2xl grid lg:grid-cols-4 grid-cols-2 py-3 bg-slate-600">
      <div className="col-span-1 ">
        <NavLink to="/">
          <h2 className="ms-4 text-lg font-bold text-white">
            Pooja E-commerce
          </h2>
        </NavLink>
      </div>
      <div className="list-none flex space-x-3  items-center  lg:justify-end justify-start lg:pe-3 ps-3 col-span-3 ">
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          ...
          <div className="flex justify-around  sm:justify-around md:justify-evenly align-items-center">
            <li className="">
              {" "}
            ...
            <li className="sm:mx-2">
              <Select value={"CETEGORY"} className="w-28">
                <Select.Option>
                ...
                {categories?.map((category) => {
                  return (
                    <Select.Option key={category?.slug}>
            ...
            {!auth.user ? (
              ...
              <>
                <li className="sm:mr-1">
                  <Select value={auth?.user?.name} className="w-24">
                    <Select.Option>
                      <NavLink
                        to={`/dashboard/${
                          auth?.user?.role === 1
            ...
            {auth?.token && auth?.user?.name != "admin" ? (
              <li>
                <div>
                  <LocalMall
                    type="button"
                  ...
                  >
                    ...
                    <div className="offcanvas-body">
                      ...
                      <div className="grid grid-cols-4 gap-2">
                        ...
                        <div className="col-span-4 text-center flex flex-col justify-center h-dvh">
